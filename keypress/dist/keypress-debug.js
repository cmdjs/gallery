define("gallery/keypress/2.0.1/keypress-debug", [], function(require, exports, module) {
    var keypress;
    ...
    (function() {
        ...
        keypress.Listener = function() {
            function Listener(element, defaults) {
                var attach_handler, property, value, _this = this;
            ...
            Listener.prototype._get_active_combos = function(key) {
                var active_combos, keys_down, _this = this;
                active_combos = [];
            ...
            Listener.prototype.unregister_combo = function(keys_or_combo) {
                var combo, unregister_combo, _i, _len, _ref, _this = this;
                if (!keys_or_combo) {
                    return false;
                }
