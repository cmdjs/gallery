 ...
 * @api public
 */
    function listjs_require(path, parent, orig) {
        var resolved = listjs_require.resolve(path);
        // lookup failed
        if (null == resolved) {
            orig = orig || path;
            parent = parent || "root";
            var err = new Error('Failed to listjs_require "' + orig + '" from "' + parent + '"');
            err.path = orig;
            err.parent = parent;
            err.listjs_require = true;
            throw err;
        }
        var module = listjs_require.modules[resolved];
        // perform real listjs_require()
        ...
        if (!module._resolving && !module.exports) {
            ...
            module.call(this, mod.exports, listjs_require.relative(resolved), mod);
 ...
 * Registered modules.
 */
    listjs_require.modules = {};
    /**
 * Registered aliases.
 */
    listjs_require.aliases = {};
    /**
 * Resolve `path`.
 *
 * Lookup:
 ...
 * @api private
 */
    listjs_require.resolve = function(path) {
        if (path.charAt(0) === "/") path = path.slice(1);
        var paths = [ path, path + ".js", path + ".json", path + "/index.js", path + "/index.json" ];
        for (var i = 0; i < paths.length; i++) {
            var path = paths[i];
            if (listjs_require.modules.hasOwnProperty(path)) return path;
            if (listjs_require.aliases.hasOwnProperty(path)) return listjs_require.aliases[path];
        }
    };
    /**
 ...
 * @api private
 */
    listjs_require.normalize = function(curr, path) {
        var segs = [];
 ...
 * @api private
 */
    listjs_require.register = function(path, definition) {
        listjs_require.modules[path] = definition;
    };
    /**
 ...
 * @api private
 */
    listjs_require.alias = function(from, to) {
        if (!listjs_require.modules.hasOwnProperty(from)) {
            throw new Error('Failed to alias "' + from + '", it does not exist');
        }
        listjs_require.aliases[to] = from;
    };
    /**
 * Return a listjs_require function relative to the `parent` path.
 *
 * @param {String} parent
 * @return {Function}
 * @api private
 */
    listjs_require.relative = function(parent) {
        var p = listjs_require.normalize(parent, "..");
        /**
   * lastIndexOf helper.
   */
        ...
        /**
   * The relative listjs_require() itself.
   */
        function localRequire(path) {
            var resolved = localRequire.resolve(path);
            return listjs_require(resolved, parent, path);
        }
        /**
   ...
   */
        localRequire.resolve = function(path) {
            ...
            if ("." == c) return listjs_require.normalize(p, path);
   ...
   */
        localRequire.exists = function(path) {
            return listjs_require.modules.hasOwnProperty(localRequire.resolve(path));
        };
        return localRequire;
    };
    listjs_require.register("component-classes/index.js", function(exports, listjs_require, module) {
        /**
 * Module dependencies.
 */
        var index = listjs_require("indexof");
        /**
 * Whitespace regexp.
 */
        var re = /\s+/;
 ...
 */
        function ClassList(el) {
            if (!el) throw new Error("A DOM element reference is listjs_required");
            this.el = el;
 ...
 */
    ...
    listjs_require.register("segmentio-extend/index.js", function(exports, listjs_require, module) {
    ...
    listjs_require.register("component-indexof/index.js", function(exports, listjs_require, module) {
 ...
 */
    ...
    listjs_require.register("javve-get-by-class/index.js", function(exports, listjs_require, module) {
        /**
 ...
 */
    ...
    listjs_require.register("javve-get-attribute/index.js", function(exports, listjs_require, module) {
        /**
 ...
 */
    ...
    listjs_require.register("javve-natural-sort/index.js", function(exports, listjs_require, module) {
        /*
 ...
 */
    ...
    listjs_require.register("javve-to-string/index.js", function(exports, listjs_require, module) {
    ...
    listjs_require.register("component-type/index.js", function(exports, listjs_require, module) {
        /**
 * toString ref.
 */
        var toString = Object.prototype.toString;
...
*/
    ...
    */
    ...
    listjs_require.register("list.js/src/search.js", function(exports, listjs_require, module) {
        var events = listjs_require("events"), getByClass = listjs_require("get-by-class"), toString = listjs_require("to-string");
    ...
    listjs_require.register("list.js/src/item.js", function(exports, listjs_require, module) {
        module.exports = function(list) {
    ...
    listjs_require.register("list.js/src/templater.js", function(exports, listjs_require, module) {
        var getByClass = listjs_require("get-by-class");
    ...
    listjs_require.register("list.js/src/filter.js", function(exports, listjs_require, module) {
        module.exports = function(list) {
            // Add handlers
    ...
    listjs_require.register("list.js/src/add-async.js", function(exports, listjs_require, module) {
        module.exports = function(list) {
    ...
    listjs_require.register("list.js/src/parse.js", function(exports, listjs_require, module) {
        module.exports = function(list) {
            var Item = listjs_require("./item")(list);
    ...
    listjs_require.alias("component-classes/index.js", "list.js/deps/classes/index.js");
    listjs_require.alias("component-classes/index.js", "classes/index.js");
    listjs_require.alias("component-indexof/index.js", "component-classes/deps/indexof/index.js");
    listjs_require.alias("segmentio-extend/index.js", "list.js/deps/extend/index.js");
    listjs_require.alias("segmentio-extend/index.js", "extend/index.js");
    listjs_require.alias("component-indexof/index.js", "list.js/deps/indexof/index.js");
    listjs_require.alias("component-indexof/index.js", "indexof/index.js");
    ...
    listjs_require.alias("javve-get-attribute/index.js", "get-attribute/index.js");
    listjs_require.alias("javve-natural-sort/index.js", "list.js/deps/natural-sort/index.js");
    listjs_require.alias("javve-natural-sort/index.js", "natural-sort/index.js");
    listjs_require.alias("javve-to-string/index.js", "list.js/deps/to-string/index.js");
    listjs_require.alias("javve-to-string/index.js", "list.js/deps/to-string/index.js");
    listjs_require.alias("javve-to-string/index.js", "to-string/index.js");
    listjs_require.alias("javve-to-string/index.js", "javve-to-string/index.js");
    listjs_require.alias("component-type/index.js", "list.js/deps/type/index.js");
    listjs_require.alias("component-type/index.js", "type/index.js");
    if (typeof exports == "object") {
        module.exports = listjs_require("list.js");
    } else if (typeof define == "function" && define.amd) {
        define(function() {
            return listjs_require("list.js");
        });
    } else {
        this["List"] = listjs_require("list.js");
    }
});
