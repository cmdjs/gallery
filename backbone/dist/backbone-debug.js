define("gallery/backbone/0.9.10/backbone-debug", [ "gallery/underscore/1.4.4/underscore-debug", "$-debug" ], function(require, exports) {
    var previousUnderscore = this._;
    var previousJQuery = this.jQuery;
    this._ = require("gallery/underscore/1.4.4/underscore-debug");
    ...
    (function() {
        ...
        g.VERSION = "0.9.10";
        var f = n._;
        !f && "undefined" !== typeof require && (f = require("gallery/underscore/1.4.4/underscore-debug"));
        ...
        f.extend(s.prototype, h, {
            ...
            add: function(a, b) {
                ...
                c = 0;
                for (d = a.length; c < d; c++) (e = this._prepareModel(g = a[c], b)) ? (p = this.get(e)) ? b.merge && (p.set(g === e ? e.attributes : g, b), 
            ...
            get: function(a) {
                if (null != a) return this._idAttr || (this._idAttr = this.model.prototype.idAttribute), 
            ...
            update: function(a, b) {
                ...
                d = 0;
                for (e = a.length; d < e; d++) c = a[d], g = this.get(c), b.remove && g && (l[g.cid] = !0), 
        ...
        f.extend(m.prototype, h, {
            ...
            start: function(a) {
                ...
                this.navigate(a));
                if (this._hasPushState) g.$(window).on("popstate", this.checkUrl); else if (this._wantsHashChange && "onhashchange" in window && !b) g.$(window).on("hashchange", this.checkUrl); else this._wantsHashChange && (this._checkUrlInterval = setInterval(this.checkUrl, this.interval));
                this.fragment = a;
                a = this.location;
